...
@export_dir var dynamic_object_tiles_dir
...
var source_id_to_dynamic_object_tile: Dictionary
...
func _ready() -> void:
	...
	build_tile_dict(dynamic_object_tiles_dir, source_id_to_dynamic_object_tile)
